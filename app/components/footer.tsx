        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          >
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-br from-amber-400 to-orange-500 rounded-full flex items-center justify-center animate-pulse-glow">
            ...
            <p className="text-amber-200 mb-6 max-w-md leading-relaxed">
              The Gulf Gecko Token - Connecting the region through innovation, 
              community, and the unstoppable spirit of the desert gecko.
            </p>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="text-amber-400 text-sm font-medium">
              Built with 🦎 for the Gulf community
            </div>
          </div>
        </motion.div>
      </div>
